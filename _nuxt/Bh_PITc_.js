import{Q as E,T as U,U as M,R as v,S as u,f7 as T,V as l,aT as h,aM as C,aE as f,aK as P,aF as V,b$ as x,aH as c,ah as N,c7 as B,aG as H}from"./BrO4EmHp.js";import{n as O,c as d,r as m,U as L}from"./TxLqNjxV.js";import"./VccNAKIp.js";import"./Bxkd3L1S.js";import"./zaJ4Z44R.js";import{e as q,n as G}from"./gkYWmTZu.js";import"./qPXAfv_A.js";import"./BuW03Nke.js";import"./Bf3RIQvt.js";const K=E`
  :host {
    position: relative;
...
`;var R=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i},S;let p=S=class extends v{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){var e;super(),this.loading=!1,this.timeoutTimeLeft=T.getTimeToNextEmailLogin(),this.error="",this.otp="",this.email=(e=l.state.data)==null?void 0:e.email,this.authConnector=h.getAuthConnector()}render(){if(!this.email)throw new Error("w3m-email-otp-widget: No email provided");const e=!!this.timeoutTimeLeft,t=this.getFooterLabels(e);return u`
      <wui-flex
    ...
    `}startOTPTimeout(){this.timeoutTimeLeft=T.getTimeToNextEmailLogin(),this.OTPTimeout=setInterval(()=>{this.timeoutTimeLeft>0?this.timeoutTimeLeft=T.getTimeToNextEmailLogin():clearInterval(this.OTPTimeout)},1e3)}async onOtpInputChange(e){var t;try{this.loading||(this.otp=e.detail,this.shouldSubmitOnOtpChange()&&(this.loading=!0,await((t=this.onOtpSubmit)==null?void 0:t.call(this,this.otp))))}catch(n){this.error=C.parseError(n),this.loading=!1}}async onResendCode(){try{if(this.onOtpResend){if(!this.loading&&!this.timeoutTimeLeft){if(this.error="",this.otp="",!h.getAuthConnector()||!this.email)throw new Error("w3m-email-otp-widget: Unable to resend email");this.loading=!0,await this.onOtpResend(this.email),this.startOTPTimeout(),f.showSuccess("Code email resent")}}else this.onStartOver&&this.onStartOver()}catch(e){f.showError(e)}finally{this.loading=!1}}getFooterLabels(e){return this.onStartOver?{title:"Something wrong?",action:`Try again ${e?`in ${this.timeoutTimeLeft}s`:""}`}:{title:"Didn't receive it?",action:`Resend ${e?`in ${this.timeoutTimeLeft}s`:"Code"}`}}shouldSubmitOnOtpChange(){return this.authConnector&&this.otp.length===S.OTP_LENGTH}};p.OTP_LENGTH=6;p.styles=Q;R([m()],p.prototype,"loading",void 0);R([m()],p.prototype,"timeoutTimeLeft",void 0);R([m()],p.prototype,"error",void 0);p=S=R([d("w3m-email-otp-widget")],p);var J=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let W=class extends p{constructor(){super(...arguments),this.onOtpSubmit=async e=>{var t,n,o;try{if(this.authConnector){const i=P.state.activeChain,r=V.getConnections(i),s=(t=x.state.remoteFeatures)==null?void 0:t.multiWallet,y=r.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),i)await V.connectExternal(this.authConnector,i);else throw new Error("Active chain is not set on ChainControll");if(c.sendEvent({type:"track",event:"CONNECT_SUCCESS",properties:{method:"email",name:this.authConnector.name||"Unknown",caipNetworkId:(n=P.getActiveCaipNetwork())==null?void 0:n.caipNetworkId}}),(o=x.state.remoteFeatures)!=null&&o.emailCapture)return;if(x.state.siwx){N.close();return}if(y&&s){l.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}N.close()}}catch(i){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:C.parseError(i)}}),i}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};W=J([d("w3m-email-verify-otp-view")],W);const X=E`
  wui-icon-box {
