import{dp as h,cD as u,cT as f,cU as g,dh as w,dk as b,dl as y}from"./BWftuhBA.js";import{r as m,c as x}from"./k02276lB.js";const o=u({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),v={state:o,subscribe(t){return g(o,()=>t(o))},subscribeKey(t,e){return f(o,t,e)},showTooltip({message:t,triggerRect:e,variant:i}){o.open=!0,o.message=t,o.triggerRect=e,o.variant=i},hide(){o.open=!1,o.message="",o.triggerRect={width:0,height:0,top:0,left:0}}},s=h(v),$=w`
  :host {
    pointer-events: none;
  }
