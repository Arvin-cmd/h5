import{aj as g,ak as m,al as w,am as f,Q as v,R as b,S as x}from"./BAumNzA0.js";import{r as u,c as h}from"./BaJ9Bo5M.js";const e=m({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),y={state:e,subscribe(o){return f(e,()=>o(e))},subscribeKey(o,t){return w(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},s=g(y),R=v`
  :host {
    pointer-events: none;
  }
