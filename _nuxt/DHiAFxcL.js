import{dG as w,fM as j,dq as l,dr as me,dh as $,di as K,dk as x,dl as d,dw as H,dj as fe,dm as T,cM as b,dZ as M,fI as we,dI as X,cF as F,cO as _,dy as G,cG as Y,dn as be,cI as P,fN as L,d_ as ge,fO as ye,fC as ve,cH as xe,ds as ke}from"./BWftuhBA.js";import{c as y,n as c,r as h,U as se}from"./k02276lB.js";import{o as E}from"./BdAFPLnU.js";import"./X6vfUaUs.js";import"./C8o-AMPh.js";import{H as oe}from"./DL8bsgOG.js";import"./T0NY8ydf.js";import"./BEWobgdt.js";import"./9AMiDrxW.js";import"./UnELzBto.js";import{S as $e}from"./b15ZPP8O.js";import"./6z8wsPDa.js";import"./B8ZjmjHW.js";import"./B4nHCBLZ.js";const le={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){w.shake();return}if(await j.isSIWXCloseDisabled()){w.shake();return}(l.state.view==="DataCapture"||l.state.view==="DataCaptureOtpConfirm")&&me.disconnect(),w.close()}},Ce=$`
  :host {
    display: block;
...
`;var Z=function(e,t,o,a){var r=arguments.length,i=r<3?t:a===null?a=Object.getOwnPropertyDescriptor(t,o):a,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,a);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(r<3?n(i):r>3?n(t,o,i):n(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};const We={info:"info",success:"checkmark",warning:"warningCircle",error:"warning"};let D=class extends x{constructor(){super(...arguments),this.message="",this.type="info"}render(){return d`
    ...
    `}onClose(){H.close()}};D.styles=[K,Ie];Z([c()],D.prototype,"message",void 0);Z([c()],D.prototype,"type",void 0);D=Z([y("wui-alertbar")],D);const Ee=$`
  :host {
    display: block;
    position: absolute;
    top: ${({spacing:e})=>e[3]};
...
`;var R=function(e,t,o,a){var r=arguments.length,i=r<3?t:a===null?a=Object.getOwnPropertyDescriptor(t,o):a,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,a);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(r<3?n(i):r>3?n(t,o,i):n(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};const Pe={lg:"lg-regular",md:"md-regular",sm:"sm-regular"},Re={lg:"lg",md:"md",sm:"sm"};let I=class extends x{constructor(){super(...arguments),this.imageSrc="",this.text="",this.size="lg",this.type="text-dropdown",this.disabled=!1}render(){return d`<button ?disabled=${this.disabled} data-size=${this.size} data-type=${this.type}>
      ${this.imageTemplate()} ${this.textTemplate()}
      <wui-flex class="right-icon-container">
        <wui-icon name="chevronBottom"></wui-icon>
      </wui-flex>
    </button>`}textTemplate(){const t=Pe[this.size];return this.text?d`<wui-text color="primary" variant=${t}>${this.text}</wui-text>`:null}imageTemplate(){if(this.imageSrc)return d`<wui-image src=${this.imageSrc} alt="select visual"></wui-image>`;const t=Re[this.size];return d` <wui-flex class="left-icon-container">
      <wui-icon size=${t} name="networkPlaceholder"></wui-icon>
    </wui-flex>`}};I.styles=[K,fe,Ae];R([c()],I.prototype,"imageSrc",void 0);R([c()],I.prototype,"text",void 0);R([c()],I.prototype,"size",void 0);R([c()],I.prototype,"type",void 0);R([c({type:Boolean})],I.prototype,"disabled",void 0);I=R([y("wui-select")],I);const Ne=$`
  :host {
    height: 60px;
  }
...
`;var W=function(e,t,o,a){var r=arguments.length,i=r<3?t:a===null?a=Object.getOwnPropertyDescriptor(t,o):a,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,a);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(r<3?n(i):r>3?n(t,o,i):n(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};const Te=["SmartSessionList"],_e={PayWithExchange:T.tokens.theme.foregroundPrimary};function ie(){var n,s,m,f,O,A,z;const e=(s=(n=l.state.data)==null?void 0:n.connector)==null?void 0:s.name,t=(f=(m=l.state.data)==null?void 0:m.wallet)==null?void 0:f.name,o=(A=(O=l.state.data)==null?void 0:O.network)==null?void 0:A.name,a=t??e,r=G.getConnectors();return{Connect:`Connect ${r.length===1&&((z=r[0])==null?void 0:z.id)==="w3m-email"?"Email":""} Wallet`,Create:"Create Wallet",ChooseAccountName:void 0,Account:void 0,AccountSettings:void 0,AllWallets:"All Wallets",ApproveTransaction:"Approve Transaction",BuyInProgress:"Buy",ConnectingExternal:a??"Connect Wallet",ConnectingWalletConnect:a??"WalletConnect",ConnectingWalletConnectBasic:"WalletConnect",ConnectingSiwe:"Sign In",Convert:"Convert",ConvertSelectToken:"Select token",ConvertPreview:"Preview Convert",Downloads:a?`Get ${a}`:"Downloads",EmailLogin:"Email Login",EmailVerifyOtp:"Confirm Email",EmailVerifyDevice:"Register Device",GetWallet:"Get a Wallet",Networks:"Choose Network",OnRampProviders:"Choose Provider",OnRampActivity:"Activity",OnRampTokenSelect:"Select Token",OnRampFiatSelect:"Select Currency",Pay:"How you pay",ProfileWallets:"Wallets",SwitchNetwork:o??"Switch Network",Transactions:"Activity",UnsupportedChain:"Switch Network",UpgradeEmailWallet:"Upgrade Your Wallet",UpdateEmailWallet:"Edit Email",UpdateEmailPrimaryOtp:"Confirm Current Email",UpdateEmailSecondaryOtp:"Confirm New Email",WhatIsABuy:"What is Buy?",RegisterAccountName:"Choose Name",RegisterAccountNameSuccess:"",WalletReceive:"Receive",WalletCompatibleNetworks:"Compatible Networks",Swap:"Swap",SwapSelectToken:"Select Token",SwapPreview:"Preview Swap",WalletSend:"Send",WalletSendPreview:"Review Send",WalletSendSelectToken:"Select Token",WalletSendConfirmed:"Confirmed",WhatIsANetwork:"What is a network?",WhatIsAWallet:"What is a Wallet?",ConnectWallets:"Connect Wallet",ConnectSocials:"All Socials",ConnectingSocial:Y.state.socialProvider?Y.state.socialProvider.charAt(0).toUpperCase()+Y.state.socialProvider.slice(1):"Connect Social",ConnectingMultiChain:"Select Chain",ConnectingFarcaster:"Farcaster",SwitchActiveChain:"Switch Chain",SmartSessionCreated:void 0,SmartSessionList:"Smart Sessions",SIWXSignMessage:"Sign In",PayLoading:"Payment in Progress",DataCapture:"Profile",DataCaptureOtpConfirm:"Confirm Email",FundWallet:"Fund Wallet",PayWithExchange:"Deposit from Exchange",PayWithExchangeSelectAsset:"Select Asset"}}let v=class extends x{constructor(){super(),this.unsubscribe=[],this.heading=ie()[l.state.view],this.network=b.state.activeCaipNetwork,this.networkImage=M.getNetworkImage(this.network),this.showBack=!1,this.prevHistoryLength=1,this.view=l.state.view,this.viewDirection="",this.unsubscribe.push(we.subscribeNetworkImages(()=>{this.networkImage=M.getNetworkImage(this.network)}),l.subscribeKey("view",t=>{setTimeout(()=>{this.view=t,this.heading=ie()[t]},X.ANIMATION_DURATIONS.HeaderText),this.onViewChange(),this.onHistoryChange()}),b.subscribeKey("activeCaipNetwork",t=>{this.network=t,this.networkImage=M.getNetworkImage(this.network)}))}disconnectCallback(){this.unsubscribe.forEach(t=>t())}render(){const t=_e[l.state.view]??T.tokens.theme.backgroundPrimary;return this.style.setProperty("--local-header-background-color",t),d`
    ...
    ></wui-icon-button>`}onNetworks(){this.isAllowedNetworkSwitch()&&(F.sendEvent({type:"track",event:"CLICK_NETWORKS"}),l.push("Networks"))}isAllowedNetworkSwitch(){const t=b.getAllRequestedCaipNetworks(),o=t?t.length>1:!1,a=t==null?void 0:t.find(({id:r})=>{var i;return r===((i=this.network)==null?void 0:i.id)});return o||!a}onViewChange(){const{history:t}=l.state;let o=X.VIEW_DIRECTION.Next;t.length<this.prevHistoryLength&&(o=X.VIEW_DIRECTION.Prev),this.prevHistoryLength=t.length,this.viewDirection=o}async onHistoryChange(){var a;const{history:t}=l.state,o=(a=this.shadowRoot)==null?void 0:a.querySelector("#dynamic");t.length>1&&!this.showBack&&o?(await o.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.showBack=!0,o.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"})):t.length<=1&&this.showBack&&o&&(await o.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.showBack=!1,o.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"}))}onGoBack(){l.goBack()}};v.styles=Ne;W([h()],v.prototype,"heading",void 0);W([h()],v.prototype,"network",void 0);W([h()],v.prototype,"networkImage",void 0);W([h()],v.prototype,"showBack",void 0);W([h()],v.prototype,"prevHistoryLength",void 0);W([h()],v.prototype,"view",void 0);W([h()],v.prototype,"viewDirection",void 0);v=W([y("w3m-header")],v);const De=$`
  :host {
    display: flex;
    align-items: center;
    gap: ${({spacing:e})=>e[1]};
...
`;var de=function(e,t,o,a){var r=arguments.length,i=r<3?t:a===null?a=Object.getOwnPropertyDescriptor(t,o):a,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(e,t,o,a);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(i=(r<3?n(i):r>3?n(t,o,i):n(t,o))||i);return r>3&&i&&Object.defineProperty(t,o,i),i};let V=class extends x{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.open=P.state.open,this.unsubscribe.push(P.subscribeKey("open",t=>{this.open=t,this.onOpen()}))}disconnectedCallback(){clearTimeout(this.timeout),this.unsubscribe.forEach(t=>t())}render(){const{message:t,variant:o}=P.state;return d` <wui-snackbar message=${t} variant=${o}></wui-snackbar> `}onOpen(){clearTimeout(this.timeout),this.open?(this.animate([{opacity:0,transform:"translateX(-50%) scale(0.85)"},{opacity:1,transform:"translateX(-50%) scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.timeout&&clearTimeout(this.timeout),P.state.autoClose&&(this.timeout=setTimeout(()=>P.hide(),2500))):this.animate([{opacity:1,transform:"translateX(-50%) scale(1)"},{opacity:0,transform:"translateX(-50%) scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"})}};V.styles=Be;de([h()],V.prototype,"open",void 0);V=de([y("w3m-snackbar")],V);const ze=$`
  :host {
