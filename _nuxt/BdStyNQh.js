import{bz as P,bA as U,bS as _,bY as D,bD as u,bH as V,bN as W,bC as $,bM as M,bB as K,bL as L,bO as F,bI as Q,bQ as q}from"./du6FXzWk.js";import{r as s,n as w,c as C,U as x}from"./Cj3DTtSp.js";import"./B4tatzIV.js";import{M as R}from"./BCoKUQRd.js";import"./BT1f4gal.js";import{S as n}from"./hSFt27Uo.js";import"./kMR66_7O.js";import"./BXpfFE1M.js";import"./D2hzk5PQ.js";import"./GZMmERzk.js";import"./D-jXdOs4.js";const H={numericInputKeyDown(l,t,e){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],r=l.metaKey||l.ctrlKey,o=l.key,a=o.toLocaleLowerCase(),c=a==="a",y=a==="c",k=a==="v",j=a==="x",E=o===",",B=o===".",N=o>="0"&&o<="9";!r&&(c||y||k||j)&&l.preventDefault(),t==="0"&&!E&&!B&&o==="0"&&l.preventDefault(),t==="0"&&N&&(e(o),l.preventDefault()),(E||B)&&(t||(e("0."),l.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&l.preventDefault()),!N&&!i.includes(o)&&!B&&!E&&l.preventDefault()}},G=P`
  :host {
    width: 100%;
  }
...
`;var T=function(l,t,e,i){var r=arguments.length,o=r<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(l,t,e,i);else for(var c=l.length-1;c>=0;c--)(a=l[c])&&(o=(r<3?a(o):r>3?a(t,e,o):a(t,e))||o);return r>3&&o&&Object.defineProperty(t,e,o),o};const J=5e-5;let m=class extends U{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const t=this.marketValue||"0",e=D.bigNumber(t).gt("0");return u`
    ...
    `}handleKeydown(t){return H.numericInputKeyDown(t,this.value,e=>{var i;return(i=this.onSetAmount)==null?void 0:i.call(this,this.target,e)})}dispatchInputChangeEvent(t){if(!this.onSetAmount)return;const e=t.target.value.replace(/[^0-9.]/gu,"");e===","||e==="."?this.onSetAmount(this.target,"0."):e.endsWith(",")?this.onSetAmount(this.target,e.replace(",",".")):this.onSetAmount(this.target,e)}setMaxValueToInput(){var t;(t=this.onSetMaxValue)==null||t.call(this,this.target,this.balance)}templateTokenSelectButton(){return this.token?u`
      <wui-flex
        class="swap-token-button"
        flexDirection="column"
        alignItems="flex-end"
