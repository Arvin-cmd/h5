import{dh as _,dk as I,dy as S,cO as u,dq as w,cN as F,dl as c,cH as b,eV as A,dw as D,cG as d,dr as E,cM as $,dI as N,cF as p,el as T,cI as v,eW as j,dG as R,d_ as P}from"./BWftuhBA.js";import{n as M,r as l,c as O}from"./k02276lB.js";import{o as x}from"./BdAFPLnU.js";import{O as k}from"./MRnqprDn.js";import{e as z}from"./B9rrG0PI.js";import"./BEWobgdt.js";import"./DB4pb4mn.js";import"./CetEskz5.js";import"./wa8s78jl.js";import"./qn4hSlSa.js";import"./BYfp64Cn.js";import"./T0NY8ydf.js";import"./C8o-AMPh.js";const q=_`
  :host {
...
`;var C=function(t,e,i,r){var s=arguments.length,o=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o};let m=class extends I{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=S.state.connectors,this.authConnector=this.connectors.find(e=>e.type==="AUTH"),this.remoteFeatures=u.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push(S.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(i=>i.type==="AUTH")}),u.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var o;let e=((o=this.remoteFeatures)==null?void 0:o.socials)||[];const i=!!this.authConnector,r=e==null?void 0:e.length,s=w.state.view==="ConnectSocials";return(!i||!r)&&!s?null:(s&&!r&&(e=F.DEFAULT_SOCIALS),c` <wui-flex flexDirection="column" gap="2">
      ${e.map(n=>c`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`)}async onSocialClick(e){e&&await z(e)}async handlePwaFrameLoad(){var e;if(b.isPWA()){this.isPwaLoading=!0;try{((e=this.authConnector)==null?void 0:e.provider)instanceof A&&await this.authConnector.provider.init()}catch(i){D.open({displayMessage:"Error loading embedded wallet in PWA",debugMessage:i.message},"error")}finally{this.isPwaLoading=!1}}}};m.styles=q;C([M()],m.prototype,"tabIdx",void 0);C([l()],m.prototype,"connectors",void 0);C([l()],m.prototype,"authConnector",void 0);C([l()],m.prototype,"remoteFeatures",void 0);C([l()],m.prototype,"isPwaLoading",void 0);m=C([O("w3m-social-login-list")],m);const B=_`
  wui-flex {
...
`;var U=function(t,e,i,r){var s=arguments.length,o=s<3?e:r===null?r=Object.getOwnPropertyDescriptor(e,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(t,e,i,r);else for(var a=t.length-1;a>=0;a--)(n=t[a])&&(o=(s<3?n(o):s>3?n(e,i,o):n(e,i))||o);return s>3&&o&&Object.defineProperty(e,i,o),o};let L=class extends I{constructor(){super(),this.unsubscribe=[],this.checked=k.state.isLegalCheckboxChecked,this.unsubscribe.push(k.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var W;const{termsConditionsUrl:e,privacyPolicyUrl:i}=u.state,r=(W=u.state.features)==null?void 0:W.legalCheckbox,n=!!(e||i)&&!!r&&!this.checked,a=n?-1:void 0;return c`
    ...
    `}};L.styles=B;U([l()],L.prototype,"checked",void 0);L=U([O("w3m-connect-socials-view")],L);const G=_`
  wui-logo {
    width: 80px;
    height: 80px;
