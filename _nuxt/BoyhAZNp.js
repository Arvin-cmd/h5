import{dh as m,dk as w,cH as E,cM as b,dr as U,fJ as l,dl as c,dq as h,cP as V,cG as z,cI as v,cN as Y,dx as J,dZ as q,di as F,dj as M,fK as G,fL as Q,ds as Z,cF as X,dG as ee}from"./BWftuhBA.js";import{n as d,r as u,c as g,U as A}from"./k02276lB.js";import"./CetEskz5.js";import"./BEWobgdt.js";import{e as H,n as L}from"./BYfp64Cn.js";import"./BwIbLLRN.js";import"./B8ZjmjHW.js";import"./oG8MxQiV.js";import{S as K}from"./b15ZPP8O.js";import"./ybiNaeao.js";import"./BuRruZ2g.js";import"./mMb8yvjp.js";import"./C8o-AMPh.js";import"./CjEoAlaX.js";import{o as te}from"./BdAFPLnU.js";import"./T0NY8ydf.js";import"./qn4hSlSa.js";const ie=m`
  :host {
    width: 100%;
    height: 100px;
...
`;var I=function(e,t,i,r){var o=arguments.length,n=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(n=(o<3?s(n):o>3?s(t,i,n):s(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let C=class extends w{constructor(){super(...arguments),this.readOnly=!1}render(){const t=this.readOnly||!this.token;return c` <wui-flex
    ...
    </wui-flex>`}onInputChange(t){l.setTokenAmount(t.detail)}onMaxClick(){if(this.token){const t=V.bigNumber(this.token.quantity.numeric);l.setTokenAmount(Number(t.toFixed(20)))}}onBuyClick(){h.push("OnRampProviders")}};C.styles=ne;I([d({type:Object})],C.prototype,"token",void 0);I([d({type:Boolean})],C.prototype,"readOnly",void 0);I([d({type:Number})],C.prototype,"sendTokenAmount",void 0);C=I([g("w3m-input-token")],C);const re=m`
  :host {
    display: block;
  }
...
`;var N=function(e,t,i,r){var o=arguments.length,n=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(n=(o<3?s(n):o>3?s(t,i,n):s(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let $=class extends w{constructor(){super(),this.unsubscribe=[],this.tokenBalances=l.state.tokenBalances,this.search="",this.onDebouncedSearch=E.debounce(t=>{this.search=t}),this.fetchBalancesAndNetworkPrice(),this.unsubscribe.push(l.subscribe(t=>{this.tokenBalances=t.tokenBalances}))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){return c`
    ...
    `}onBuyClick(){h.push("OnRampProviders")}onInputChange(t){this.onDebouncedSearch(t.detail)}handleTokenClick(t){l.setToken(t),l.setTokenAmount(void 0),h.goBack()}};$.styles=oe;N([u()],$.prototype,"tokenBalances",void 0);N([u()],$.prototype,"tokens",void 0);N([u()],$.prototype,"filteredTokens",void 0);N([u()],$.prototype,"search",void 0);$=N([g("w3m-wallet-send-select-token-view")],$);const se=m`
  :host {
    height: 32px;
    display: flex;
    align-items: center;
...
`;var _=function(e,t,i,r){var o=arguments.length,n=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(n=(o<3?s(n):o>3?s(t,i,n):s(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let S=class extends w{constructor(){var t;super(...arguments),this.params=(t=h.state.data)==null?void 0:t.send}render(){return c` <wui-text variant="sm-regular" color="secondary">Details</wui-text>
      ...
      ></wui-list-content>`:null}onNetworkClick(t){t&&!this.params&&h.push("Networks",{network:t})}};S.styles=le;_([d()],S.prototype,"receiverAddress",void 0);_([d({type:Object})],S.prototype,"caipNetwork",void 0);_([u()],S.prototype,"params",void 0);S=_([g("w3m-wallet-send-details")],S);const ce=m`
  wui-avatar,
  wui-image {
    display: ruby;
    width: 32px;
...
`;var k=function(e,t,i,r){var o=arguments.length,n=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(n=(o<3?s(n):o>3?s(t,i,n):s(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let f=class extends w{constructor(){var t;super(),this.unsubscribe=[],this.token=l.state.token,this.sendTokenAmount=l.state.sendTokenAmount,this.receiverAddress=l.state.receiverAddress,this.receiverProfileName=l.state.receiverProfileName,this.receiverProfileImageUrl=l.state.receiverProfileImageUrl,this.caipNetwork=b.state.activeCaipNetwork,this.loading=l.state.loading,this.params=(t=h.state.data)==null?void 0:t.send,this.unsubscribe.push(l.subscribe(i=>{this.token=i.token,this.sendTokenAmount=i.sendTokenAmount,this.receiverAddress=i.receiverAddress,this.receiverProfileName=i.receiverProfileName,this.receiverProfileImageUrl=i.receiverProfileImageUrl,this.loading=i.loading}),b.subscribeKey("activeCaipNetwork",i=>this.caipNetwork=i))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}render(){var t,i;return c` <wui-flex flexDirection="column" .padding=${["0","4","4","4"]}>
    ...
    >`}sendValueTemplate(){if(!this.params&&this.token&&this.sendTokenAmount){const i=this.token.price*this.sendTokenAmount;return c`<wui-text variant="md-regular" color="primary"
      ...
      >`}return null}async onSendClick(){if(!this.sendTokenAmount||!this.receiverAddress){v.showError("Please enter a valid amount and receiver address");return}try{await l.sendToken(),this.params?h.reset("WalletSendConfirmed"):(v.showSuccess("Transaction started"),h.replace("Account"))}catch(t){let i="Failed to send transaction. Please try again.";const r=t instanceof G&&t.originalName===Q.PROVIDER_RPC_ERROR_NAME.USER_REJECTED_REQUEST;(b.state.activeChain===Z.CHAIN.SOLANA||r)&&t instanceof Error&&(i=t.message),X.sendEvent({type:"track",event:r?"SEND_REJECTED":"SEND_ERROR",properties:l.getSdkEventProperties(t)}),v.showError(i)}}onCancelClick(){h.goBack()}};f.styles=ce;k([u()],f.prototype,"token",void 0);k([u()],f.prototype,"sendTokenAmount",void 0);k([u()],f.prototype,"receiverAddress",void 0);k([u()],f.prototype,"receiverProfileName",void 0);k([u()],f.prototype,"receiverProfileImageUrl",void 0);k([u()],f.prototype,"caipNetwork",void 0);k([u()],f.prototype,"loading",void 0);k([u()],f.prototype,"params",void 0);f=k([g("w3m-wallet-send-preview-view")],f);const ue=m`
  .icon-box {
    width: 64px;
    height: 64px;
    border-radius: 16px;
...
`;var de=function(e,t,i,r){var o=arguments.length,n=o<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(n=(o<3?s(n):o>3?s(t,i,n):s(t,i))||n);return o>3&&n&&Object.defineProperty(t,i,n),n};let D=class extends w{constructor(){super(),this.unsubscribe=[],this.unsubscribe.push()}render(){return c`
    ...
    `}onCloseClick(){ee.close()}};D.styles=ue;D=de([g("w3m-send-confirmed-view")],D);export{D as W3mSendConfirmedView,$ as W3mSendSelectTokenView,f as W3mWalletSendPreviewView,p as W3mWalletSendView};
