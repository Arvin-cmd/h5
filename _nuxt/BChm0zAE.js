import{Q as y,T,U as N,R as w,S as l,aK as d,b$ as v,cH as Ee,aU as S,aO as C,aM as b,ah as D,aH as A,br as re,aT as m,aG as $,V as f,aR as V,aE as _,aI as ye,aJ as ae,aF as x,cL as hn,W as Wi,dd as _e,de as ve,df as Q,cD as wn,X as fn,c6 as E,dg as Te,c0 as mn,aP as bn,c7 as gn,aV as Qt,dh as xn,di as vn,cI as Ei}from"./riPymW3M.js";import{n as c,c as h,o as p,U as F,r as u,a as Jt}from"./CrbRC2Lc.js";import"./CgWmce0U.js";import"./DVWIt2ax.js";import"./BbBgB5Wk.js";import"./GVUk-Zpo.js";import{W as cr}from"./68k-vbdg.js";import"./ckmKA5df.js";import"./CY3O1CW_.js";import"./CBlLm-8m.js";import"./C33KZYqm.js";import{n as yn}from"./MaEJnvJR.js";import"./C47iNF83.js";import"./CVj9xiXh.js";import{M as mt}from"./DAhSo57a.js";import"./D5rkEXsb.js";import"./Dg3MMAyM.js";import{e as pi,n as hi}from"./B-jIoxpm.js";import"./ElXoFwGu.js";import"./Bg3jRYLu.js";import"./DPYYHxE1.js";import{O as bt}from"./DFIJByHi.js";import{e as Cn}from"./CLVXVGqo.js";import{N as $n}from"./PnIgF2uE.js";import"./B6qA8p_1.js";import"./Da3fZAfB.js";import"./Bik86kxp.js";import"./CQjiTTrf.js";import"./DJz_k-9G.js";import"./Dmg8YACJ.js";const Sn=y`
  :host {
    display: block;
  }
...
`;var Ii=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var r=a.length-1;r>=0;r--)(s=a[r])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let dt=class extends w{constructor(){super(...arguments),this.icon="externalLink",this.text=""}render(){return l`
    ...
    `}};dt.styles=[T,N,Go];Ii([c()],dt.prototype,"icon",void 0);Ii([c()],dt.prototype,"text",void 0);dt=Ii([h("wui-banner")],dt);const Ko=y`
  :host > wui-flex {
    max-height: clamp(360px, 540px, 80vh);
    overflow: scroll;
    scrollbar-width: none;
...
`;var Xo=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var r=a.length-1;r>=0;r--)(s=a[r])&&(i=(o<3?s(i):o>3?s(e,t,i):s(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let di=class extends w{constructor(){var e,t;super(...arguments),this.dappImageUrl=(e=v.state.metadata)==null?void 0:e.icons,this.walletImageUrl=(t=C.state.connectedWalletInfo)==null?void 0:t.icon}firstUpdated(){var t;const e=(t=this.shadowRoot)==null?void 0:t.querySelectorAll("wui-visual-thumbnail");e!=null&&e[0]&&this.createAnimation(e[0],"translate(18px)"),e!=null&&e[1]&&this.createAnimation(e[1],"translate(-18px)")}render(){var e;return l`
    ...
    `}async onSign(){this.isSigning=!0;try{await Ei.requestSignMessage()}catch(e){if(e instanceof Error&&e.message.includes("OTP is required")){_.showError({message:"Something went wrong. We need to verify your account again."}),f.replace("DataCapture");return}throw e}finally{this.isSigning=!1}}async onCancel(){this.isCancelling=!0,await Ei.cancelSignMessage().finally(()=>this.isCancelling=!1)}};ki([u()],Rt.prototype,"isCancelling",void 0);ki([u()],Rt.prototype,"isSigning",void 0);Rt=ki([h("w3m-siwx-sign-message-view")],Rt);export{Ti as AppKitAccountButton,Ri as AppKitButton,Pi as AppKitConnectButton,Li as AppKitNetworkButton,_i as W3mAccountButton,le as W3mAccountSettingsView,ii as W3mAccountView,Ct as W3mAllWalletsView,Ni as W3mButton,_t as W3mChooseAccountNameView,Oi as W3mConnectButton,H as W3mConnectView,Tt as W3mConnectWalletsView,Mi as W3mConnectingExternalView,Wt as W3mConnectingMultiChainView,ri as W3mConnectingWcBasicView,Ge as W3mConnectingWcView,Ki as W3mDownloadsView,Hi as W3mGetWalletView,Di as W3mNetworkButton,ct as W3mNetworkSwitchView,De as W3mNetworksView,j as W3mProfileWalletsView,cr as W3mRouter,Rt as W3mSIWXSignMessageView,Nt as W3mSwitchActiveChainView,ut as W3mUnsupportedChainView,ui as W3mWalletCompatibleNetworksView,Yi as W3mWhatIsANetworkView,qi as W3mWhatIsAWalletView};
