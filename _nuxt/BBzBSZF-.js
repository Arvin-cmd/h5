import{bz as R,bA as k,bD as a,bI as T,bS as C,c8 as p,bM as O,bC as Y,bU as z,bN as V,bL as E,bO as F}from"./CTDKT58D.js";import{n as l,c as _,o as j,r as v}from"./BRMLB2Zy.js";import{T as A,D as U}from"./kIT7Ypw9.js";import"./CNWbn57I.js";import"./BhyRGusP.js";import"./DfMx8Ad7.js";var N;(function(o){o.approve="approved",o.bought="bought",o.borrow="borrowed",o.burn="burnt",o.cancel="canceled",o.claim="claimed",o.deploy="deployed",o.deposit="deposited",o.execute="executed",o.mint="minted",o.receive="received",o.repay="repaid",o.send="sent",o.sell="sold",o.stake="staked",o.trade="swapped",o.unstake="unstaked",o.withdraw="withdrawn"})(N||(N={}));const W=R`
  :host > wui-flex {
    display: flex;
...
`;var w=function(o,t,e,r){var s=arguments.length,i=s<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,e):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(o,t,e,r);else for(var c=o.length-1;c>=0;c--)(n=o[c])&&(i=(s<3?n(i):s>3?n(t,e,i):n(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i};let d=class extends k{constructor(){super(...arguments),this.type="approve",this.onlyDirectionIcon=!1,this.images=[],this.price=[],this.amount=[],this.symbol=[]}render(){return a`
    ...
    `}templateDescription(){var e;const t=(e=this.descriptions)==null?void 0:e[0];return t?a`
        ...
        `:null}};d.styles=[T,M];w([l()],d.prototype,"type",void 0);w([l({type:Array})],d.prototype,"descriptions",void 0);w([l()],d.prototype,"date",void 0);w([l({type:Boolean})],d.prototype,"onlyDirectionIcon",void 0);w([l()],d.prototype,"status",void 0);w([l()],d.prototype,"direction",void 0);w([l({type:Array})],d.prototype,"images",void 0);w([l({type:Array})],d.prototype,"price",void 0);w([l({type:Array})],d.prototype,"amount",void 0);w([l({type:Array})],d.prototype,"symbol",void 0);d=w([_("wui-transaction-list-item")],d);const G=R`
  :host {
    min-height: 100%;
  }
