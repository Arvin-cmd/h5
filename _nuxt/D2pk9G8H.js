import{af as $,ag as _,ah as R,L as f,O as m,M as b,N as l,bS as s,P as O}from"./D_vluf58.js";import{n as P,c as w,o as j,r as y}from"./BYFU15Ix.js";import{e as T,n as U}from"./D8ytEW07.js";import{R as B}from"./Dmg8YACJ.js";const u=$({isLegalCheckboxChecked:!1}),g={state:u,subscribe(n){return R(u,()=>n(u))},subscribeKey(n,e){return _(u,n,e)},setIsLegalCheckboxChecked(n){u.isLegalCheckboxChecked=n}},L=f`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
...
`;var v=function(n,e,r,o){var i=arguments.length,t=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,r):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,o);else for(var c=n.length-1;c>=0;c--)(a=n[c])&&(t=(i<3?a(t):i>3?a(e,r,t):a(e,r))||t);return i>3&&t&&Object.defineProperty(e,r,t),t};let h=class extends b{constructor(){super(...arguments),this.inputElementRef=T(),this.checked=void 0}render(){return l`
    ...
    `}dispatchChangeEvent(){var e;this.dispatchEvent(new CustomEvent("checkboxChange",{detail:(e=this.inputElementRef.value)==null?void 0:e.checked,bubbles:!0,composed:!0}))}};h.styles=[m,L];v([P({type:Boolean})],h.prototype,"checked",void 0);h=v([w("wui-checkbox")],h);const E=f`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
