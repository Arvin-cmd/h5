import{L as D,M as C,aL as P,aE as _,N as u,aS as V,aI as W,R as S,aP as j,aN as K,ac as M,aJ as F,aK as Q,O as H,P as q}from"./Di62khzb.js";import{r as s,n as w,c as U,U as x}from"./BTpCxpKO.js";import"./qGIALmQd.js";import{M as R}from"./Shz2rV23.js";import"./DHlHAort.js";import{S as n}from"./C5IWG_wR.js";import"./q_MBtr69.js";import"./CkkXXySG.js";import"./CJcR4FKU.js";import"./CDfgJWiL.js";import"./B6ZGMgF2.js";import"./7ybSIpM6.js";const G={numericInputKeyDown(c,t,e){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],a=c.metaKey||c.ctrlKey,o=c.key,r=o.toLocaleLowerCase(),l=r==="a",m=r==="c",v=r==="v",L=r==="x",E=o===",",O=o===".",B=o>="0"&&o<="9";!a&&(l||m||v||L)&&c.preventDefault(),t==="0"&&!E&&!O&&o==="0"&&c.preventDefault(),t==="0"&&B&&(e(o),c.preventDefault()),(E||O)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!i.includes(o)&&!O&&!E&&c.preventDefault()}},J=D`
  :host {
    width: 100%;
  }
...
`;var k=function(c,t,e,i){var a=arguments.length,o=a<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(c,t,e,i);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(o=(a<3?r(o):a>3?r(t,e,o):r(t,e))||o);return a>3&&o&&Object.defineProperty(t,e,o),o};const X=V.CONVERT_SLIPPAGE_TOLERANCE;let f=class extends C{constructor(){var t;super(),this.unsubscribe=[],this.networkName=(t=P.state.activeCaipNetwork)==null?void 0:t.name,this.detailsOpen=!1,this.sourceToken=n.state.sourceToken,this.toToken=n.state.toToken,this.toTokenAmount=n.state.toTokenAmount,this.sourceTokenPriceInUSD=n.state.sourceTokenPriceInUSD,this.toTokenPriceInUSD=n.state.toTokenPriceInUSD,this.priceImpact=n.state.priceImpact,this.maxSlippage=n.state.maxSlippage,this.networkTokenSymbol=n.state.networkTokenSymbol,this.inputError=n.state.inputError,this.unsubscribe.push(n.subscribe(e=>{this.sourceToken=e.sourceToken,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.priceImpact=e.priceImpact,this.maxSlippage=e.maxSlippage,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError}))}render(){const t=this.toTokenAmount&&this.maxSlippage?_.bigNumber(this.toTokenAmount).minus(this.maxSlippage).toString():null;if(!this.sourceToken||!this.toToken||this.inputError)return null;const e=this.sourceTokenPriceInUSD&&this.toTokenPriceInUSD?1/this.toTokenPriceInUSD*this.sourceTokenPriceInUSD:0;return u`
    ...
    `}toggleDetails(){this.detailsOpen=!this.detailsOpen}};f.styles=[J];k([s()],f.prototype,"networkName",void 0);k([w()],f.prototype,"detailsOpen",void 0);k([s()],f.prototype,"sourceToken",void 0);k([s()],f.prototype,"toToken",void 0);k([s()],f.prototype,"toTokenAmount",void 0);k([s()],f.prototype,"sourceTokenPriceInUSD",void 0);k([s()],f.prototype,"toTokenPriceInUSD",void 0);k([s()],f.prototype,"priceImpact",void 0);k([s()],f.prototype,"maxSlippage",void 0);k([s()],f.prototype,"networkTokenSymbol",void 0);k([s()],f.prototype,"inputError",void 0);f=k([U("w3m-swap-details")],f);const Y=D`
  :host {
    width: 100%;
  }
...
`;var z=function(c,t,e,i){var a=arguments.length,o=a<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(c,t,e,i);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(o=(a<3?r(o):a>3?r(t,e,o):r(t,e))||o);return a>3&&o&&Object.defineProperty(t,e,o),o};let N=class extends C{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};N.styles=[Y];z([w()],N.prototype,"target",void 0);N=z([U("w3m-swap-input-skeleton")],N);const Z=D`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var y=function(c,t,e,i){var a=arguments.length,o=a<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(c,t,e,i);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(o=(a<3?r(o):a>3?r(t,e,o):r(t,e))||o);return a>3&&o&&Object.defineProperty(t,e,o),o};const tt=5e-5;let b=class extends C{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const t=this.marketValue||"0",e=_.bigNumber(t).gt("0");return u`
...
`;var h=function(c,t,e,i){var a=arguments.length,o=a<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(c,t,e,i);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(o=(a<3?r(o):a>3?r(t,e,o):r(t,e))||o);return a>3&&o&&Object.defineProperty(t,e,o),o};let p=class extends C{constructor(){var t,e;super(),this.unsubscribe=[],this.initialParams=(t=S.state.data)==null?void 0:t.swap,this.detailsOpen=!1,this.caipAddress=j.state.caipAddress,this.caipNetworkId=(e=P.state.activeCaipNetwork)==null?void 0:e.caipNetworkId,this.initialized=n.state.initialized,this.loadingQuote=n.state.loadingQuote,this.loadingPrices=n.state.loadingPrices,this.loadingTransaction=n.state.loadingTransaction,this.sourceToken=n.state.sourceToken,this.sourceTokenAmount=n.state.sourceTokenAmount,this.sourceTokenPriceInUSD=n.state.sourceTokenPriceInUSD,this.toToken=n.state.toToken,this.toTokenAmount=n.state.toTokenAmount,this.toTokenPriceInUSD=n.state.toTokenPriceInUSD,this.inputError=n.state.inputError,this.fetchError=n.state.fetchError,this.lastTokenPriceUpdate=0,this.minTokenPriceUpdateInterval=1e4,this.visibilityChangeHandler=()=>{document!=null&&document.hidden?(clearInterval(this.interval),this.interval=void 0):this.startTokenPriceInterval()},this.startTokenPriceInterval=()=>{this.interval&&Date.now()-this.lastTokenPriceUpdate<this.minTokenPriceUpdateInterval||(this.lastTokenPriceUpdate&&Date.now()-this.lastTokenPriceUpdate>this.minTokenPriceUpdateInterval&&this.fetchTokensAndValues(),clearInterval(this.interval),this.interval=setInterval(()=>{this.fetchTokensAndValues()},this.minTokenPriceUpdateInterval))},this.watchTokensAndValues=()=>{!this.sourceToken||!this.toToken||(this.subscribeToVisibilityChange(),this.startTokenPriceInterval())},this.onDebouncedGetSwapCalldata=K.debounce(async()=>{await n.swapTokens()},200),P.subscribeKey("activeCaipNetwork",i=>this.onCaipNetworkChange({newCaipNetwork:i,resetSwapState:!0,initializeSwapState:!1})),j.subscribeKey("caipAddress",i=>this.onCaipAddressChange({newCaipAddress:i,resetSwapState:!0,initializeSwapState:!1})),this.unsubscribe.push(P.subscribeKey("activeCaipNetwork",i=>this.onCaipNetworkChange({newCaipNetwork:i,resetSwapState:!1,initializeSwapState:!0})),j.subscribeKey("caipAddress",i=>this.onCaipAddressChange({newCaipAddress:i,resetSwapState:!1,initializeSwapState:!0})),M.subscribeKey("open",i=>{i||n.resetState()}),S.subscribeKey("view",i=>{i.includes("Swap")||n.resetValues()}),n.subscribe(i=>{this.initialized=i.initialized,this.loadingQuote=i.loadingQuote,this.loadingPrices=i.loadingPrices,this.loadingTransaction=i.loadingTransaction,this.sourceToken=i.sourceToken,this.sourceTokenAmount=i.sourceTokenAmount,this.sourceTokenPriceInUSD=i.sourceTokenPriceInUSD,this.toToken=i.toToken,this.toTokenAmount=i.toTokenAmount,this.toTokenPriceInUSD=i.toTokenPriceInUSD,this.inputError=i.inputError,this.fetchError=i.fetchError,i.sourceToken&&i.toToken&&this.watchTokensAndValues()}))}async firstUpdated(){n.initializeState(),this.watchTokensAndValues(),await this.handleSwapParameters()}disconnectedCallback(){this.unsubscribe.forEach(t=>t==null?void 0:t()),clearInterval(this.interval),document==null||document.removeEventListener("visibilitychange",this.visibilityChangeHandler)}render(){return u`
    ...
    </wui-flex>`}onSwitchTokens(){n.switchTokens()}async onSwapPreview(){var t,e;this.fetchError&&await n.swapTokens(),W.sendEvent({type:"track",event:"INITIATE_SWAP",properties:{network:this.caipNetworkId||"",swapFromToken:((t=this.sourceToken)==null?void 0:t.symbol)||"",swapToToken:((e=this.toToken)==null?void 0:e.symbol)||"",swapFromAmount:this.sourceTokenAmount||"",swapToAmount:this.toTokenAmount||"",isSmartAccount:F(P.state.activeChain)===Q.ACCOUNT_TYPES.SMART_ACCOUNT}}),S.push("SwapPreview")}async handleSwapParameters(){this.initialParams&&(n.state.initialized||await new Promise(e=>{const i=n.subscribeKey("initialized",a=>{a&&(i==null||i(),e())})}),await this.setSwapParameters(this.initialParams))}async setSwapParameters({amount:t,fromToken:e,toToken:i}){(!n.state.tokens||!n.state.myTokensWithBalance)&&await new Promise(r=>{const l=n.subscribeKey("myTokensWithBalance",m=>{m&&m.length>0&&(l==null||l(),r())});setTimeout(()=>{l==null||l(),r()},5e3)});const a=[...n.state.tokens||[],...n.state.myTokensWithBalance||[]];if(e){const o=a.find(r=>r.symbol.toLowerCase()===e.toLowerCase());o&&n.setSourceToken(o)}if(i){const o=a.find(r=>r.symbol.toLowerCase()===i.toLowerCase());o&&n.setToToken(o)}t&&!isNaN(Number(t))&&n.setSourceTokenAmount(t)}onCaipAddressChange({newCaipAddress:t,resetSwapState:e,initializeSwapState:i}){this.caipAddress!==t&&(this.caipAddress=t,e&&n.resetState(),i&&n.initializeState())}onCaipNetworkChange({newCaipNetwork:t,resetSwapState:e,initializeSwapState:i}){this.caipNetworkId!==(t==null?void 0:t.caipNetworkId)&&(this.caipNetworkId=t==null?void 0:t.caipNetworkId,e&&n.resetState(),i&&n.initializeState())}};p.styles=et;h([w({type:Object})],p.prototype,"initialParams",void 0);h([s()],p.prototype,"interval",void 0);h([s()],p.prototype,"detailsOpen",void 0);h([s()],p.prototype,"caipAddress",void 0);h([s()],p.prototype,"caipNetworkId",void 0);h([s()],p.prototype,"initialized",void 0);h([s()],p.prototype,"loadingQuote",void 0);h([s()],p.prototype,"loadingPrices",void 0);h([s()],p.prototype,"loadingTransaction",void 0);h([s()],p.prototype,"sourceToken",void 0);h([s()],p.prototype,"sourceTokenAmount",void 0);h([s()],p.prototype,"sourceTokenPriceInUSD",void 0);h([s()],p.prototype,"toToken",void 0);h([s()],p.prototype,"toTokenAmount",void 0);h([s()],p.prototype,"toTokenPriceInUSD",void 0);h([s()],p.prototype,"inputError",void 0);h([s()],p.prototype,"fetchError",void 0);h([s()],p.prototype,"lastTokenPriceUpdate",void 0);p=h([U("w3m-swap-view")],p);const it=D`
  :host > wui-flex:first-child {
    overflow-y: auto;
    overflow-x: hidden;
    scrollbar-width: none;
...
`;var A=function(c,t,e,i){var a=arguments.length,o=a<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(c,t,e,i);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(o=(a<3?r(o):a>3?r(t,e,o):r(t,e))||o);return a>3&&o&&Object.defineProperty(t,e,o),o};let $=class extends C{constructor(){super(),this.observer=new IntersectionObserver(()=>{}),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(t=>{t.forEach(e=>{e.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){var e;if(!this.visible)return null;const t=this.amount&&this.price?(e=_.multiply(this.price,this.amount))==null?void 0:e.toFixed(3):null;return u`
    ...
    `}visualTemplate(){return this.imageError?u`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};$.styles=[H,q,ot];A([w()],$.prototype,"imageSrc",void 0);A([w()],$.prototype,"name",void 0);A([w()],$.prototype,"symbol",void 0);A([w()],$.prototype,"price",void 0);A([w()],$.prototype,"amount",void 0);A([s()],$.prototype,"visible",void 0);A([s()],$.prototype,"imageError",void 0);$=A([U("wui-token-list-item")],$);const nt=D`
  :host {
      ...
      <wui-flex class="tokens-container">
        <wui-flex class="tokens" .padding=${["0","s","s","s"]} flexDirection="column">
          ${(i==null?void 0:i.length)>0?u`
                ...
                ${i.map(o=>{var l,m,v;const r=o.symbol===((l=this.sourceToken)==null?void 0:l.symbol)||o.symbol===((m=this.toToken)==null?void 0:m.symbol);return u`
                    <wui-token-list-item
