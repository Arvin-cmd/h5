import{Q as D,R as C,aK as P,aD as _,S as u,aR as V,aH as W,V as S,aO as j,aM as K,ah as M,aI as F,aJ as Q,T as H,U as q}from"./BrO4EmHp.js";import{r as s,n as w,c as U,U as x}from"./TxLqNjxV.js";import"./qPXAfv_A.js";import{M as R}from"./vbIEOblQ.js";import"./B-mk5ErQ.js";import{S as n}from"./DbTRN09Q.js";import"./CxNCkPQy.js";import"./Bf3RIQvt.js";import"./T25pa1PF.js";import"./Bxkd3L1S.js";import"./zaJ4Z44R.js";import"./gkYWmTZu.js";const G={numericInputKeyDown(c,t,e){const i=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],a=c.metaKey||c.ctrlKey,o=c.key,r=o.toLocaleLowerCase(),l=r==="a",m=r==="c",v=r==="v",L=r==="x",E=o===",",B=o===".",N=o>="0"&&o<="9";!a&&(l||m||v||L)&&c.preventDefault(),t==="0"&&!E&&!B&&o==="0"&&c.preventDefault(),t==="0"&&N&&(e(o),c.preventDefault()),(E||B)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!N&&!i.includes(o)&&!B&&!E&&c.preventDefault()}},J=D`
  :host {
    width: 100%;
  }
...
`;var z=function(c,t,e,i){var a=arguments.length,o=a<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(c,t,e,i);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(o=(a<3?r(o):a>3?r(t,e,o):r(t,e))||o);return a>3&&o&&Object.defineProperty(t,e,o),o};let O=class extends C{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};O.styles=[Y];z([w()],O.prototype,"target",void 0);O=z([U("w3m-swap-input-skeleton")],O);const Z=D`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
