import{dh as h,dk as g,dq as u,dl as e,cF as P,di as k,dj as A}from"./BWftuhBA.js";import{r as f,c as y,n as c}from"./k02276lB.js";import"./6z8wsPDa.js";import{H as b}from"./DL8bsgOG.js";import{o as W}from"./BdAFPLnU.js";import"./BEWobgdt.js";import"./B4nHCBLZ.js";const O=h`
  :host {
    display: block;
  }
...
`;var $=function(t,i,r,n){var o=arguments.length,a=o<3?i:n===null?n=Object.getOwnPropertyDescriptor(i,r):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,i,r,n);else for(var l=t.length-1;l>=0;l--)(s=t[l])&&(a=(o<3?s(a):o>3?s(i,r,a):s(i,r))||a);return o>3&&a&&Object.defineProperty(i,r,a),a};let d=class extends g{constructor(){super(...arguments),this.resizeObserver=void 0,this.unsubscribe=[],this.status="hide",this.view=u.state.view}firstUpdated(){this.status=b.hasFooter()?"show":"hide",this.unsubscribe.push(u.subscribeKey("view",i=>{this.view=i,this.status=b.hasFooter()?"show":"hide",this.status==="hide"&&document.documentElement.style.setProperty("--apkt-footer-height","0px")})),this.resizeObserver=new ResizeObserver(i=>{for(const r of i)if(r.target===this.getWrapper()){const n=`${r.contentRect.height}px`;document.documentElement.style.setProperty("--apkt-footer-height",n)}}),this.resizeObserver.observe(this.getWrapper())}render(){return e`
