import{c0 as ie,c5 as Z,b$ as K,c6 as F,bS as U,bJ as se,bL as I,c7 as oe,c3 as ne,c4 as ae,bz as R,bA as y,bD as c,c8 as N,c9 as C,bU as D,bB as _,b_ as ce,bN as ee,bO as te,bC as E,bM as q,bH as V,bT as le,bP as M,bF as ue}from"./CTDKT58D.js";import{n as p,c as g,o as h,r as d}from"./BRMLB2Zy.js";import{D as de,T as pe}from"./kIT7Ypw9.js";import"./CNWbn57I.js";import"./DfMx8Ad7.js";import"./C7vSsbpb.js";import"./ww0NyUQR.js";import{O as Y}from"./j2qWhZD_.js";import"./BhyRGusP.js";import"./zQ2gOu-0.js";import"./D9O7IcPV.js";import"./BIW8KDzV.js";const j={id:"2b92315d-eab7-5bef-84fa-089a131333f5",name:"USD Coin",symbol:"USDC",networks:[{name:"ethereum-mainnet",display_name:"Ethereum",chain_id:"1",contract_address:"0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"},{name:"polygon-mainnet",display_name:"Polygon",chain_id:"137",contract_address:"0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174"}]},H={id:"USD",payment_method_limits:[{id:"card",min:"10.00",max:"7500.00"},{id:"ach_bank_account",min:"10.00",max:"25000.00"}]},me={providers:Z,selectedProvider:null,error:null,purchaseCurrency:j,paymentCurrency:H,purchaseCurrencies:[j],paymentCurrencies:[],quotesLoading:!1},l=ie(me),u={state:l,subscribe(s){return ae(l,()=>s(l))},subscribeKey(s,e){return ne(l,s,e)},setSelectedProvider(s){if(s&&s.name==="meld"){const e=U.state.activeChain===se.CHAIN.SOLANA?"SOL":"USDC",t=I.state.address??"",i=new URL(s.url);i.searchParams.append("publicKey",oe),i.searchParams.append("destinationCurrencyCode",e),i.searchParams.append("walletAddress",t),s.url=i.toString()}l.selectedProvider=s},setPurchaseCurrency(s){l.purchaseCurrency=s},setPaymentCurrency(s){l.paymentCurrency=s},setPurchaseAmount(s){this.state.purchaseAmount=s},setPaymentAmount(s){this.state.paymentAmount=s},async getAvailableCurrencies(){const s=await K.getOnrampOptions();l.purchaseCurrencies=s.purchaseCurrencies,l.paymentCurrencies=s.paymentCurrencies,l.paymentCurrency=s.paymentCurrencies[0]||H,l.purchaseCurrency=s.purchaseCurrencies[0]||j,await F.fetchCurrencyImages(s.paymentCurrencies.map(e=>e.id)),await F.fetchTokenImages(s.purchaseCurrencies.map(e=>e.symbol))},async getQuote(){var s,e;l.quotesLoading=!0;try{const t=await K.getOnrampQuote({purchaseCurrency:l.purchaseCurrency,paymentCurrency:l.paymentCurrency,amount:((s=l.paymentAmount)==null?void 0:s.toString())||"0",network:(e=l.purchaseCurrency)==null?void 0:e.symbol});return l.quotesLoading=!1,l.purchaseAmount=Number(t==null?void 0:t.purchaseAmount.amount),t}catch(t){return l.error=t.message,l.quotesLoading=!1,null}finally{l.quotesLoading=!1}},resetState(){l.providers=Z,l.selectedProvider=null,l.error=null,l.purchaseCurrency=j,l.paymentCurrency=H,l.purchaseCurrencies=[j],l.paymentCurrencies=[],l.paymentAmount=void 0,l.purchaseAmount=void 0,l.quotesLoading=!1}},he=R`
  :host {
    width: 100%;
  }
...
`;var z=function(s,e,t,i){var o=arguments.length,r=o<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,t):i,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(s,e,t,i);else for(var a=s.length-1;a>=0;a--)(n=s[a])&&(r=(o<3?n(r):o>3?n(e,t,r):n(e,t))||r);return o>3&&r&&Object.defineProperty(e,t,r),r};let k=class extends y{constructor(){super(),this.unsubscribe=[],this.selectedCurrency=u.state.purchaseCurrencies,this.tokens=u.state.purchaseCurrencies,this.tokenImages=C.state.tokenImages,this.checked=Y.state.isLegalCheckboxChecked,this.unsubscribe.push(u.subscribe(e=>{this.selectedCurrency=e.purchaseCurrencies,this.tokens=e.purchaseCurrencies}),C.subscribeKey("tokenImages",e=>this.tokenImages=e),Y.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var a;const{termsConditionsUrl:e,privacyPolicyUrl:t}=D.state,i=(a=D.state.features)==null?void 0:a.legalCheckbox,n=!!(e||t)&&!!i&&!this.checked;return c`
    ...
    `}currenciesTemplate(e=!1){return this.tokens.map(t=>{var i;return c`
      ...
      `})}selectToken(e){e&&(u.setPurchaseCurrency(e),_.close())}};k.styles=xe;z([d()],k.prototype,"selectedCurrency",void 0);z([d()],k.prototype,"tokens",void 0);z([d()],k.prototype,"tokenImages",void 0);z([d()],k.prototype,"checked",void 0);k=z([g("w3m-onramp-token-select-view")],k);const Ce=R`
  @keyframes shake {
    0% {
