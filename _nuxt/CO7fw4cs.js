import{N as E,Q as U,R as M,O as v,P as u,f6 as S,S as l,aW as h,aP as C,aH as f,aN as D,aI as N,bU as x,aK as c,ae as V,c0 as B,aJ as H}from"./CjEckXE1.js";import{n as O,c as d,r as m,U as W}from"./NnAnKpR3.js";import"./CZiJRgv-.js";import"./DDLXfI5W.js";import"./D436OJKt.js";import{e as q,n as K}from"./CbWHawqh.js";import"./DiJ9OiaG.js";import"./8ey6gq1k.js";import"./CvNimzvj.js";const G=E`
  :host {
    position: relative;
...
`;var $=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let g=class extends v{constructor(){super(...arguments),this.disabled=!1,this.value=""}render(){return u`<input
      ...
      value=${this.value}
    /> `}};g.styles=[U,M,G];$([O({type:Boolean})],g.prototype,"disabled",void 0);$([O({type:String})],g.prototype,"value",void 0);g=$([d("wui-input-numeric")],g);const Y=E`
  :host {
    position: relative;
    display: block;
  }
...
`;var R=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i},T;let p=T=class extends v{firstUpdated(){this.startOTPTimeout()}disconnectedCallback(){clearTimeout(this.OTPTimeout)}constructor(){var e;super(),this.loading=!1,this.timeoutTimeLeft=S.getTimeToNextEmailLogin(),this.error="",this.otp="",this.email=(e=l.state.data)==null?void 0:e.email,this.authConnector=h.getAuthConnector()}render(){if(!this.email)throw new Error("w3m-email-otp-widget: No email provided");const e=!!this.timeoutTimeLeft,t=this.getFooterLabels(e);return u`
    ...
    `}startOTPTimeout(){this.timeoutTimeLeft=S.getTimeToNextEmailLogin(),this.OTPTimeout=setInterval(()=>{this.timeoutTimeLeft>0?this.timeoutTimeLeft=S.getTimeToNextEmailLogin():clearInterval(this.OTPTimeout)},1e3)}async onOtpInputChange(e){var t;try{this.loading||(this.otp=e.detail,this.shouldSubmitOnOtpChange()&&(this.loading=!0,await((t=this.onOtpSubmit)==null?void 0:t.call(this,this.otp))))}catch(n){this.error=C.parseError(n),this.loading=!1}}async onResendCode(){try{if(this.onOtpResend){if(!this.loading&&!this.timeoutTimeLeft){if(this.error="",this.otp="",!h.getAuthConnector()||!this.email)throw new Error("w3m-email-otp-widget: Unable to resend email");this.loading=!0,await this.onOtpResend(this.email),this.startOTPTimeout(),f.showSuccess("Code email resent")}}else this.onStartOver&&this.onStartOver()}catch(e){f.showError(e)}finally{this.loading=!1}}getFooterLabels(e){return this.onStartOver?{title:"Something wrong?",action:`Try again ${e?`in ${this.timeoutTimeLeft}s`:""}`}:{title:"Didn't receive it?",action:`Resend ${e?`in ${this.timeoutTimeLeft}s`:"Code"}`}}shouldSubmitOnOtpChange(){return this.authConnector&&this.otp.length===T.OTP_LENGTH}};p.OTP_LENGTH=6;p.styles=J;R([m()],p.prototype,"loading",void 0);R([m()],p.prototype,"timeoutTimeLeft",void 0);R([m()],p.prototype,"error",void 0);p=T=R([d("w3m-email-otp-widget")],p);var Q=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let L=class extends p{constructor(){super(...arguments),this.onOtpSubmit=async e=>{var t,n,o;try{if(this.authConnector){const i=D.state.activeChain,r=N.getConnections(i),s=(t=x.state.remoteFeatures)==null?void 0:t.multiWallet,y=r.length>0;if(await this.authConnector.provider.connectOtp({otp:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_PASS"}),i)await N.connectExternal(this.authConnector,i);else throw new Error("Active chain is not set on ChainControll");if(c.sendEvent({type:"track",event:"CONNECT_SUCCESS",properties:{method:"email",name:this.authConnector.name||"Unknown",caipNetworkId:(n=D.getActiveCaipNetwork())==null?void 0:n.caipNetworkId}}),(o=x.state.remoteFeatures)!=null&&o.emailCapture)return;if(x.state.siwx){V.close();return}if(y&&s){l.replace("ProfileWallets"),f.showSuccess("New Wallet Added");return}V.close()}}catch(i){throw c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_FAIL",properties:{message:C.parseError(i)}}),i}},this.onOtpResend=async e=>{this.authConnector&&(await this.authConnector.provider.connectEmail({email:e}),c.sendEvent({type:"track",event:"EMAIL_VERIFICATION_CODE_SENT"}))}}};L=Q([d("w3m-email-verify-otp-view")],L);const X=E`
  wui-icon-box {
...
`;var P=function(a,e,t,n){var o=arguments.length,i=o<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(a,e,t,n);else for(var s=a.length-1;s>=0;s--)(r=a[s])&&(i=(o<3?r(i):o>3?r(e,t,i):r(e,t))||i);return o>3&&i&&Object.defineProperty(e,t,i),i};let b=class extends v{constructor(){var e,t;super(...arguments),this.formRef=q(),this.initialEmail=((e=l.state.data)==null?void 0:e.email)??"",this.redirectView=(t=l.state.data)==null?void 0:t.redirectView,this.email="",this.loading=!1}firstUpdated(){var e;(e=this.formRef.value)==null||e.addEventListener("keydown",t=>{t.key==="Enter"&&this.onSubmitEmail(t)})}render(){return u`
