import{Q as f,R as w,aR as I,aP as x,aK as H,cL as l,S as u,T as z,U as W,V as g,aI as q,aZ as F,aJ as _,aM as M,aN as Y,aO as K}from"./BAumNzA0.js";import{n as d,r as c,c as m,U as b,o as J}from"./BaJ9Bo5M.js";import"./C7NBLV_z.js";import"./h3bdXkTa.js";import{e as O,n as D}from"./DjIQhCsg.js";import{n as Q,s as Z}from"./Dmg8YACJ.js";import"./CPok7Sc1.js";import{S as L}from"./BlOhfBMN.js";import"./Db3i07KT.js";import"./DbBPSrbs.js";import"./DcSNPp0h.js";import"./S9CGsH0T.js";import"./s6oNu0es.js";const G=f`
  :host {
    width: 100%;
    height: 100px;
...
`;var B=function(o,e,i,n){var r=arguments.length,t=r<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,i):n,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(o,e,i,n);else for(var a=o.length-1;a>=0;a--)(s=o[a])&&(t=(r<3?s(t):r>3?s(e,i,t):s(e,i))||t);return r>3&&t&&Object.defineProperty(e,i,t),t};let C=class extends w{constructor(){super(...arguments),this.inputElementRef=O(),this.disabled=!1,this.value="",this.placeholder="0"}render(){var e;return(e=this.inputElementRef)!=null&&e.value&&this.value&&(this.inputElementRef.value.value=this.value),u`<input
    ...
    /> `}dispatchInputChangeEvent(e){var n,r;const i=e.data;if(i&&((n=this.inputElementRef)!=null&&n.value))if(i===","){const t=this.inputElementRef.value.value.replace(",",".");this.inputElementRef.value.value=t,this.value=`${this.value}${t}`}else Q.test(i)||(this.inputElementRef.value.value=this.value.replace(new RegExp(i.replace(Z,"\\$&"),"gu"),""));this.dispatchEvent(new CustomEvent("inputChange",{detail:(r=this.inputElementRef.value)==null?void 0:r.value,bubbles:!0,composed:!0}))}};C.styles=[z,W,X];B([d({type:Boolean})],C.prototype,"disabled",void 0);B([d({type:String})],C.prototype,"value",void 0);B([d({type:String})],C.prototype,"placeholder",void 0);C=B([m("wui-input-amount")],C);const ee=f`
  :host {
    width: 100%;
    height: 100px;
    border-radius: var(--wui-border-radius-s);
