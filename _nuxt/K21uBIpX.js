import{Q as y,T as $,U as R,R as C,S as l,aO as m,aK as d,aE as h,aU as f,aV as x,aI as I,aJ as A,V as T,aM as S}from"./riPymW3M.js";import{n as k,c as N,U as O,o as E,r as g}from"./CrbRC2Lc.js";import"./Da3fZAfB.js";import"./CgWmce0U.js";import"./Bik86kxp.js";const _=y`
  button {
    display: flex;
...
`;var b=function(n,e,r,t){var s=arguments.length,i=s<3?e:t===null?t=Object.getOwnPropertyDescriptor(e,r):t,o;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(n,e,r,t);else for(var a=n.length-1;a>=0;a--)(o=n[a])&&(i=(s<3?o(i):s>3?o(e,r,i):o(e,r))||i);return s>3&&i&&Object.defineProperty(e,r,i),i};let p=class extends C{constructor(){super(...arguments),this.networkImages=[""],this.text=""}render(){return l`
    ...
    </wui-flex>`}};p.styles=[$,R,_];b([k({type:Array})],p.prototype,"networkImages",void 0);b([k()],p.prototype,"text",void 0);p=b([N("wui-compatible-network")],p);const U=y`
    ...
    >
      ...
      >
        <wui-qr-code
          ...
          uri=${this.address}
          ?arenaClear=${!0}
          color=${E(x.state.themeVariables["--w3m-qr-color"])}
